...
| `:remote:owner` | Android library 모듈 | Owner 17 API 생성 (v3 식자재 검색·추천·상품 목록 포함) |
...
- 2026-09-18 API 갱신: `GET /owner/products` 상품 목록과 목록 응답 schema를 추가하고, 기존 v3 소비자·식자재 계약은 유지한다. 상세는 `remote/README.md`를 참고한다.
