...
data class TermsUiState(
    ...
    val isRequiredAllChecked: Boolean get() = !isLoading && failure == null && items.isNotEmpty() && items.filter { it.document.requirement == TermsRequirement.REQUIRED }.all { it.isChecked }
}
