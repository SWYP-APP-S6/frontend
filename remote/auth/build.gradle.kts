...
val specification = rootProject.layout.buildDirectory.file("openapi/auth.json")

extensions.configure<LibraryExtension> {
    namespace = "com.swyp.mangro.remote.auth"
}
...
tasks.named<GenerateTask>("openApiGenerate") {
    ...
    packageName.set("com.swyp.mangro.remote.auth")
    apiPackage.set("com.swyp.mangro.remote.auth.service")
    modelPackage.set("com.swyp.mangro.remote.auth.model")
