...
val specification = rootProject.layout.buildDirectory.file("openapi/owner.json")

extensions.configure<LibraryExtension> {
    namespace = "com.swyp.mangro.remote.owner"
}
...
tasks.named<GenerateTask>("openApiGenerate") {
    ...
    packageName.set("com.swyp.mangro.remote.owner")
    apiPackage.set("com.swyp.mangro.remote.owner.service")
    modelPackage.set("com.swyp.mangro.remote.owner.model")
