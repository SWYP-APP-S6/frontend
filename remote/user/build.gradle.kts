...
val specification = rootProject.layout.buildDirectory.file("openapi/user.json")

extensions.configure<LibraryExtension> {
    namespace = "com.swyp.mangro.remote.user"
}
...
tasks.named<GenerateTask>("openApiGenerate") {
    ...
    packageName.set("com.swyp.mangro.remote.user")
    apiPackage.set("com.swyp.mangro.remote.user.service")
    modelPackage.set("com.swyp.mangro.remote.user.model")
