...
import com.swyp.mangro.feature.owner.product.navigation.OwnerProductDetailDestination
...
internal fun OwnerNavHost(
    ...
    NavHost(navController, startDestination = OwnerHomeDestination) {
        ownerHomeNavGraph(
            ...
            navigateToProducts = { navController.navigate(OwnerProductListDestination) { launchSingleTop = true } },
